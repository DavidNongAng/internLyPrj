...
import { NavLink } from 'react-router-dom'; //Link allows you to navigate linkes between pages in a single page application (SPA). So it doesn't refresh the page everytime you change the link.
